 <!--
		...
		<!-- PRESENTATION PROGRAMME D ACTIVITES ICEJ BENIN -->
		<?php include("header.php")
?>
		<?php include("navigation_benin.html");
        ?>
		<!-- Start Feature Section togo-->
                <div class="container mycontainer">
					<div class="row">
                        <div class="section-title text-center mytitle">
                            <h3>PROGRAMME D'ACTIVITES</h3>
                        </div>
                    </div>
                    <div class = "row">
